            ...
            <d-form>
              <d-form-row>
                ...
                <d-col md="4" class="form-group">
                  ...
                  <d-form-input type="text" id="feFirstName" placeholder="First Name" value="Ivan" />
                </d-col>

                <!-- Last Name -->
                <d-col md="4" class="form-group">
                  <label for="feLastName">Last Name</label>
                  <d-form-input type="text" id="feLastName" placeholder="Last Name" value="Silva" />
                </d-col>
                ...
                <d-col md="4" class="form-group">
                  ...
                  <d-select :value="null" id="feInputState">
                    <option :value="null" selected>Developer</option>
                    <option>Sales</option>
              ...
              <d-form-row>
                ...
                <d-col md="6" class="form-group">
                  ...
                  <d-form-input type="email" id="feEmail" placeholder="Email Address" value="ivan@daltix.com" />
                </d-col>
